...
# Instance and local variables are similar in that they are both limited in scope--that is, they are accessable only within the instance, method, or other block in which they were created. But while local variables are lost as soon as their method or block returns a value and concludes, instance variables persist as long as the object they belong to remains in existence.
