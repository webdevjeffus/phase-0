...
# Note: This file has been converted to a markdown file for easier reading. That file can be found at:
# https://github.com/webdevjeffus/phase-0/blob/master/week-5/pad-array/pad_solution.md
...
# 1. Initial Solution - follows pseudocode closely
...
# 3. Refactored Solution - eliminates unnecessary if/else conditional
...
#3.5 A leaner refactored solution - uses Array#fill to replace until loop
