...
# A complete copy of this file, in easy-to-read markdown format, can be found at:
# https://github.com/webdevjeffus/phase-0/blob/master/week-5/nums-commas/comma_ps.md

# 0. Pseudocode

# What is the input? A positive integer ("positive_int").
# What is the output? The number as string, with the digits separated into columns by threes (e.g. "35", "1,000", "45,321")
...
# => Simplifies implementation of index and index checks,
# => but actually makes code longer...
...
# => I cobbled this together taking elements from a handful of stackoverflow
# => answers.
#=>
...
# The final refactored solution is more of a stunt than anything: just proving the method can be written on a single line. It's much too hard to read without careful parsing to be very practical in a real codebase that has to be maintained. If I were going to use its logic, I'd probably look for logical places to split it onto three or four lines, so less is happening on each line.